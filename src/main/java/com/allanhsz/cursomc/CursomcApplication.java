...
import com.allanhsz.cursomc.domain.ItemPedidoPK;
...
public class CursomcApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "maria@gamil.com", "36378912377", TipoCliente.PESSOA_FISICA);
