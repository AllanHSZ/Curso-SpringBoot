...
import com.allanhsz.cursomc.domain.ItemPedido;
import com.allanhsz.cursomc.domain.Pagamento;
import com.allanhsz.cursomc.domain.PagamentoComBoleto;
import com.allanhsz.cursomc.domain.PagamentoComCartao;
import com.allanhsz.cursomc.domain.Pedido;
import com.allanhsz.cursomc.domain.Produto;
import com.allanhsz.cursomc.domain.enums.EstadoPagamento;
...
import com.allanhsz.cursomc.repositories.EstadoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		Categoria cat1 = new Categoria(null, "Informátoca");
		...
		cli1.getTelefones().addAll(Arrays.asList("555555555555", "22222222222"));
		
		Cliente cli2 = new Cliente(null, "Allan Henrique", "allanhsz@outlook.com", "07839305008", TipoCliente.PESSOA_FISICA, pe.encode("123"));
		cli2.getTelefones().addAll(Arrays.asList("77777777777", "7777777777"));
		cli2.addPerfil(Perfil.ADMIN);
		
		Endereco e1 = new Endereco(null, "Rua Flores", "360", "Apto 203", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida avenia", "777", "Sala 0", "Centro", "40028922", cli2, c2);
